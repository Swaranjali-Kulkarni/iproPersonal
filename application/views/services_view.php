...
mark {
  ...
  <body style="font-family: 'Roboto';font-size: 18px">
...
<br><br><br>
            ...
            <div id="myCarousel" class="carousel slide" data-ride="carousel" >
                ...
                <div class="carousel-inner" role="listbox">
                    <div class="item active">
                        <img src="<?php echo base_url('temp-img/img3.jpg'); ?>" alt="Image" style="height: 373px ;width: 1168px" >
                        <div class="carousel-caption">
                            </div>
                    </div>

                    <div class="item">
                   <img src="<?php echo base_url('temp-img/toys.png'); ?>" alt="Image" style="height: 373px ;width: 1168px" >
                        <div class="carousel-caption">
                            </div>
                    </div>
    ...
    <div class="container" style="margin-top: 10px;margin-left: 250px;font-size: 16px;text-align:justify;">
        <div class="row ">
        </br></br>
           <p>
...
<br><br>
      <div class="container">
           <div class="row" style="margin-top: 10px;margin-left: 60px;font-size: 16px;text-align:justify;">
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; It is a contactless, non-destructive technology that helps digitally captures the surface shape of a physical object by using a line of laser light or by superimposing several images files in real time.3D scanners create cloud point of data from the surface of an object and collectively compiles the data to provide a 3d digital output in form of an STL file. </br>3D scanning is also a way to capture a physical object with exact size and shape into digital file the computer can read data digitally from the 3D representation of the Object. </br></br>
           There are Different 3d scanners and 3d scanning techniques for different applications like industrial, novelty, architecture, reverse engineering, etc. </br></br></br></br>
...
<!--Rapid prototyping-->
 ...
 <div class="container" style="margin-left:250px" id="div3"  >
      ...
      <div class="container" style="margin-top: 60px;margin-left: 250px;font-size: 16px">
           <div class="row">
...
<div class="container" style="margin-left:250px" id="div4" >
    ...
    <div class="container">
           <div class="row" style="margin-top: 60px;margin-left: 60px;font-size: 16px">
...
<div class="container"  style="margin-top: 60px;margin-left: 250px">
    <div class="row">
       ...
       <p style="text-align:justify;font-size: 16px"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Reverse engineering is a method used to understand an item and its interaction with various components. It is helpful when you want to create an exact copy or customize according to your needs of a common product with a 3D printer.</p></br></br>
    </br>
    </br>
    </div>
</div>
...
<div class="container" style="margin-top: 10px;margin-left: 250px">
    <div class="row">
           ...
           &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;The topology optimization technique is a very helpful tool for optimizing a design/part and make it more efficient in every aspect. The technology was not used before as the result output for most of the time s was not manufacturable due to the manufacturing constraints but due to additive manufacturing technology or popularly known name as 3d printing has now made it is possible to manufacture all critical parts/components by removing all the barriers of manufacturing constraints.</br></br></p>       
</br> </br>
 </div>
   </div>
   ...
   <div class="container" style="margin-left:250px" id="div8">
     ...
     <img src="<?php echo base_url('temp-img/batch4.jpg'); ?>" alt="Image" style="height: 373px ;width: 1168px" >
      ...
      <div class="container" style="margin-top: 30px;margin-left: 250px">
           ...
           <p style="text-align:justify;font-size: 16px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Small batch production can be done using 3d printing technology for directly producing end use parts.SLS (Selective laser sintering), DMLS (Direct Metal Laser Sintering), SLA (Stereolithography), etc. machines are ideally suited to producing low volume plastic and metal parts, from one to as many as thousands.</br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;3D printing produces parts in engineering grade and biocompatible materials which provides both strong and accurate parts as well as affordable which makes it a perfect application for your batch production needs.<//p>
...
<div class="container" style="margin-top: 10px;margin-left: 250px">
    <div class="row" >
           ...
           <p style="text-align:justify;font-size: 16px">&nbsp;&nbsp;&nbsp;&nbsp;It is a highly adaptable technology that is capable of producing parts in a wide range of polyurethane(PU) resins and cast nylon. 
...
<div class="container" style="margin-top: 10px;margin-left: 250px">
    <div class="row">
        ...
        <p style="text-align:justify;font-size: 16px ">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Tooling is also known as machine tooling. It is the manufacturing of components, tools and machines needed for production. The common categories of machine tooling include fixture, jigs, gauges, moulds, dies, cutting equipment, patterns, etc.</p></br> </br>
        <br><br><br>
    </div>
</div>
</section>
...
<div class="container" style="margin-top: 10px;margin-left: 250px">
    <div class="row">
           ...
           <p style="text-align:justify;font-size: 16px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Injection molding is a process for producing parts by injecting molten materials into a mold.It is done using variety of materials which mainly include metals, glasses, elastomers, and most commonly thermoplastics and thermosetting polymers.</p>       
    </br>
    <br>
    </br>
    </div>
...
<div class="container" style="margin-top: 10px;margin-left: 250px">
    <div class="row">
           ...
           <p style="text-align:justify;font-size: 16px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;CNC (Computer Numeric Control) machining process used in the manufacturing industry that involves the use of computers to control machine tools.Tools that can be controlled in this manner include lathes, mills, routers, grinders, etc.</p>
          </br></br>
           </div>
      </div>
    </section>
