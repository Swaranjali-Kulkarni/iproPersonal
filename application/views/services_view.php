            ...
            <div id="myCarousel" class="carousel slide" data-ride="carousel" >
                ...
                <div class="carousel-inner" role="listbox">
                    <div class="item active">
                        <img src="<?php echo base_url('temp-img/img3.jpg'); ?>" alt="Image" style="height: 373px ;width: 1024px" >
                        <div class="carousel-caption">
                            </div>
                    </div>

                    <div class="item">
                   <img src="<?php echo base_url('temp-img/toys.png'); ?>" alt="Image" style="height: 373px ;width: 1024px" >
                        <div class="carousel-caption">
                            </div>
                    </div>
...
<div class="container" id="div2" >
           <div class="row">
           <h2 style="text-align: center;"><mark><b>Scanning</b><mark></h2>
               <div id="myCarousel" class="carousel slide" data-ride="carousel">
...
<!--Rapid prototyping-->
 ...
 <div class="container"  id="div3" >
           <div class="row">
           <h2 style="text-align: center;"><mark><b>Rapid Prototyping</b><mark></h2>
               <div id="myCarousel" class="carousel slide" data-ride="carousel">
...
<div class="container" id="div4" >
           <div class="row">
           <h3 style="text-align: center; "><mark><b>3D and 2D CAD Modelling/Designing</b><mark></h3>
               <div id="myCarousel" class="carousel slide" data-ride="carousel">
...
<div class="container" id="div5" >
    <div class="row">
           ...
           <h3 style="text-align: center;"><mark><b>Design for 3D printing </b><mark></h3>
        <br>
...
<div class="container" id="div6" >
    <div class="row">
        <h2 style="text-align: center;"><mark><b>Reverse Engineering</b><mark></h2>
        <br>
        <div id="myCarousel" class="carousel slide" data-ride="carousel">
...
<div class="container"  id="div7" >
    <div class="row">
        <h2 style="text-align: center;"><mark><b>Design Topology Optimization</b><mark></h2>
        <br>
        <div id="myCarousel" class="carousel slide" data-ride="carousel">
...
<div class="container" style=" padding: 20px;">
   ...
   <div class="container"id="div8">
        <div class="row">
            <h2 style="text-align:center"><mark><b>Small Batch Production</b><mark></h2>
            <br>
...
<div class="container"id="div8">
    <div class="row">
        <h2 style="text-align: center;"><mark><b>Vaccum Casting</b><mark></h2>
        <br>
        <div id="myCarousel" class="carousel slide" data-ride="carousel">
...
<div class="container"id="div9">
    <div class="row">
        <h2 style="text-align: center;"><mark><b>X-Ray Topology</b><mark></h2>
        <br>
        <div id="myCarousel" class="carousel slide" data-ride="carousel">
...
<div class="container"id="div10">
    <div class="row">
        <h2 style="text-align: center;"><mark><b>Functional Part Manufacturing</b><mark></h2>
        <br>
        <div id="myCarousel" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner" role="listbox">
                ...
                <div class="item active">
     <img src="<?php echo base_url('temp-img/fun1.jpg'); ?>" alt="Image" style="height: 373px ;width: 1024px" >
                    <div class="carousel-caption">
                        <!-- <h1>MAHARASHTRA VOCATIONAL TRAINING CENTER</h1>
                         <p> Affiliated to Maharashtra State Board of Vocational Education Examination, Mumbai </p>
                         <h3>Institute Code: 170523</h3> -->
                ...
                <div class="item">
     <img src="<?php echo base_url('temp-img/fun2.jpg'); ?>" alt="Image" style="height: 373px ;width: 1024px" >               <img src="../temp-img/fun2.jpg" alt="Image" style="height: 373px ;width: 1024px">
                    <div class="carousel-caption">
                        <!--<h1>MAHARASHTRA VOCATIONAL TRAINING CENTER</h1>
                        <p> Affiliated to Maharashtra State Board of Vocational Education Examination, Mumbai </p>
                        <h3>Institute Code: 170523</h3> -->
...
<div class="container"id="div11">
    <div class="row">
        <h2 style="text-align: center;"><mark><b>Tooling Manufacturing</b><mark></h2>
        <br>
        <div id="myCarousel" class="carousel slide" data-ride="carousel">
...
<div class="container" style="padding: 20px;">
    <div class="row">
        ...
        <p style="text-align:justify;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Tooling is also known as machine tooling. It is the manufacturing of components, tools and machines needed for production. The common categories of machine tooling include fixture, jigs, gauges, moulds, dies, cutting equipment, patterns, etc.</p></br> </br>
    </div>
</div>
...
<div class="container"id="div12">
    <div class="row">
        <h2 style="text-align: center;"><mark><b>Injection Modeling</b><mark></h2>
        <br>
        <div id="myCarousel" class="carousel slide" data-ride="carousel">
...
<div class="container" style="padding: 20px;">
    <div class="row">
           ...
           <p style="text-align:justify;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Injection molding is a process for producing parts by injecting molten materials into a mold.It is done using variety of materials which mainly include metals, glasses, elastomers, and most commonly thermoplastics and thermosetting polymers.</p>       
    </br>
    </br>
    </div>
   </div>
...
<div class="container"id="div13">
    <div class="row">
        <h2 style="text-align: center;"><mark><b>CNC Machining</b><mark></h2>
        <br>
        <div id="myCarousel" class="carousel slide" data-ride="carousel">
...
<div class="container" style="padding: 20px;">
    <div class="row">
           ...
           <p style="text-align:justify;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;CNC (Computer Numeric Control) machining process used in the manufacturing industry that involves the use of computers to control machine tools.Tools that can be controlled in this manner include lathes, mills, routers, grinders, etc.</p>
          </br></br>
           </div>
      </div>
