<html>
<body>
<a href="<?php echo base_url('/Control_services/index1'); ?>"  class="w3-bar-item w3-button"></a>
...
<a href="manufacturing.php" class="w3-bar-item w3-button">Small Batch Manufacturing</a>
