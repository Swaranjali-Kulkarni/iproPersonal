...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" style="font-size:40px;letter-spacing: 0px;" href="#myPage"><b style="font-weight: bolder; "><img src="<?php echo base_url();?>temp-img/logoUp.png"  height="30">iPRO3D</b></a>
        </div>
                ...
                <li>
                    ...
                    <a href="#">
                            ...
                            <!--    <a href="../Aboutus/aboutus.php">About Us</a>-->
                                ...
                                <a href="<?php echo base_url(); ?>index.php/Welcome/history_fun">History</a>
                                <a href="<?php echo base_url(); ?>index.php/Welcome/overview_fun">Our Approach</a>
                                <a href="<?php echo base_url(); ?>index.php/Welcome/overview_fun">Our Team</a>
                                <a href="<?php echo base_url(); ?>index.php/Welcome/overview_fun">Company Ethics</a>
                                <a href="<?php echo base_url(); ?>index.php/Welcome/overview_fun">Authentic</a>
                                <a href="<?php echo base_url(); ?>index.php/Welcome/overview_fun">Accuracy</a>
                                <a href="<?php echo base_url(); ?>index.php/Welcome/overview_fun">Careers</a>                                
                            </div>
                ...
                <li>
                    ...
                    <a href="#">
                        ...
                        <div class="dropdown-content">
                            ...
                            <a href="<?php echo base_url(); ?>index.php/Welcome/services_fun">3D Scanning</a>
                            <a href="<?php echo base_url(); ?>index.php/Welcome/services_fun">Rapid Prototyping</a>
                            <a href="<?php echo base_url(); ?>index.php/Welcome/services_fun">3D & 2D CAD Modeling</a>
                            <a href="<?php echo base_url(); ?>index.php/Welcome/services_fun">Design for 3D Printing</a>
                            <a href="<?php echo base_url(); ?>index.php/Welcome/services_fun">Reverse Engineering</a>
                            <a href="<?php echo base_url(); ?>index.php/Welcome/services_fun">More...</a>
                    </div>
