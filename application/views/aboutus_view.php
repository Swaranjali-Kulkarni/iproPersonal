        ...
        <div class="row" >
            <section id="about"><br><br><br><br>
                <h2 style="text-align: center;font-weight: bold;font-family: 'Philosopher'">About Us</h2>
                    ...
                    <h4 style="text-align:justify;font-weight:bold;color:gray;">IPRO3D a socially responsible business:</h4>
                    <ol>
       ...
       <div class="row" >
        <section id="overview" data-sr><br><br><br><br>
          ...
          <p style="text-align:justify;padding:20px;">
              ...
              also process worldwide delivery according to the order quantity.<br><br>
    ...
    <h2 style="text-align: center;font-weight: bold;font-family: 'Philosopher'">Our Team</h2>  
      ...
      <div class="row">
           <div class="col-sm-3 card" style="background-color:#DCDCDC;padding-left:40px">
                <center><img src="<?php echo base_url(); ?>img/team/t1.jpg" alt="Dan" class="card-img-top img-circle" height="150px"></center>
          ...
          <div class="col-sm-3 card" style="background-color:#DCDCDC;padding-left:40px">
                <center><img src="<?php echo base_url(); ?>img/team/t3.jpg" class="card-img-top img-circle" height="150px"></center>
           ...
           <div class="col-sm-3" style="background-color:#DCDCDC;padding-left:40px">
                <center><img src="<?php echo base_url(); ?>img/team/t4.jpg" class="card-img-top img-circle" height="150px"></center>
      ...
      <div class="container" style="text-align:justify;padding:20px;background-color: #F0F0F0">
      <div class="row">
    ...
    <div class="container" style="background-color: #F0F0F0">
        <div class="row">
           ...
           <ol>
             ...
             <h4><b><li>Mutual Non-Disclosure Agreements</li></b></h4>
             <ul type="none">
    ...
    <div class="container" style="background-color: #F0F0F0">
            <div class="row" >
                 ...
                 <div style="text-align: right;">
                  ...
                  <h4 style="text-align:justify; font-weight:bold ">Internship</h4>
